    ...
    varieties: [
      {
        ...
        img: veggieWrap,
        description:
          "A whole wheat or spinach wrap filled with fresh vegetables and hummus.",
      },
      {
        name: "Turkey or Chicken Sandwich - $8.50",
        img: turkeySandwich,
        description:
          "Lean turkey or grilled chicken breast on whole grain bread with lettuce and tomato.",
      },
      {
    ...
    varieties: [
      {
        ...
        img: grain,
        description:
          "Brown rice or quinoa topped with assorted veggies, nuts, and a light dressing.",
      },
      {
        name: "Smoothie Bowls - $8.50",
        img: smoothie,
        description:
          "Blended fruits and vegetables topped with granola and seeds.",
      },
    ],
  },
  {
    ...
    varieties: [
      {
        ...
        img: infusedWater,
        description:
          "Water infused with fruits and herbs for a refreshing drink.",
      },
      {
        name: "Smoothies - $5.00",
        img: smoothiesLight,
