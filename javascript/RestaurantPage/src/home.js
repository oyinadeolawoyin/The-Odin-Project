...
restaurantTagline.textContent = "Light Bites, Fresh Flavors—Experience Wholesome Eating!";
...
food1Tagline.textContent = "Garden Fresh Salad: A vibrant mix of seasonal greens, ripe tomatoes, and our house dressing.";
...
food2Tagline.textContent = "Grilled Veggie Wrap: Roasted vegetables wrapped in a soft tortilla with creamy avocado spread.";
...
storyPara2.textContent = "Founded on the principles of health and flavor, Wholesome Bites is a cozy restaurant dedicated to providing light yet satisfying meals made from locally sourced ingredients. Our team is passionate about food and committed to sustainability."
...
offerPara2.textContent = "Join Us for Special Events: Check out our upcoming events and promotions. Join us for Wine Wednesdays and enjoy discounts on select bottles!"
...
testPara2.textContent = '"The best place for light and healthy meals!" - Jane D';
...
footer.innerHTML = "<p>Contact: (123) 456-7890</p><p>Address: 123 Healthy Lane, Food Town</p>";
